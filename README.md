...
### Automatic Scoring of Geometry Drawing
...
In addition to academic research, I have worked on practical AI and data-system projects in industry settings. These projects are especially relevant to applied AI, computer vision, data science, and product-oriented R&D roles.

#### Social Media Data Platform and Analytics
At HIIP Asia, I worked on a company-wide data platform for social media analytics. The system collected data from multiple social networks and supported downstream analysis for viral marketing and campaign insights.

**Keywords:** data crawling, social media analytics, data systems, MongoDB, SQL/NoSQL, marketing intelligence

#### Brand–Influencer Recommendation System
I built recommendation models to match brands with suitable influencers for marketing campaigns. The project combined social media data, user profiles, content analysis, and campaign requirements to support data-driven influencer selection.

**Keywords:** recommendation systems, ranking, user profiling, social media data, campaign optimization

#### Image and Text Classification for Social Media Data
I developed AI models for analyzing crawled social media content, including image/text classification tasks for extracting useful signals from large-scale online data.

**Keywords:** image classification, text classification, multimodal data, content analysis, data mining

#### HME Recognition Server
I built an AI server for handwritten mathematical expression recognition and handwriting recognition for mathematics, English, and Japanese.

**Keywords:** handwriting recognition, HME recognition, REST API, AI deployment, online/offline recognition

#### Sushi Recognition
I developed a computer vision model for detecting and recognizing multiple types of sushi in real-world images.

**Keywords:** object detection, image classification, food recognition, computer vision

#### Japanese Wine Classification
I built an image classification model for distinguishing more than 200 types of Japanese wine.

**Keywords:** fine-grained classification, product recognition, computer vision

#### Asian Face Recognition
I developed a face recognition model focusing on Asian face datasets and real-world recognition scenarios.

**Keywords:** face recognition, metric learning, image classification, computer vision

#### Traffic Video Analytics
I worked on systems for estimating and visualizing traffic parameters from video, including vehicle detection, tracking, and real-time video processing.

**Keywords:** vehicle detection, object tracking, video analytics, OpenCV, FFMPEG, real-time systems
...
- **ICDAR 2023 CROHME: Competition on Recognition of Handwritten Mathematical Expressions**  
  *ICDAR, 2023*  
  Yejing Xie, Harold Mouchère, Foteini Simistira Liwicki, Sumit Rakesh, Rajkumar Saini, Masaki Nakagawa, Cuong Tuan Nguyen, Thanh-Nghia Truong
...
- **Automatic Scoring System for Digitized Handwritten Answers**  
  *IEEE Access, 2026*  
  Tomo Asakura, Hung Tuan Nguyen, Thanh-Nghia Truong, Yoichi Tsuchida, Takahiro Yamamoto, Hiroshi Miyazawa, Nam Tuan Ly, Masato Nemoto, Masamitsu Ito, Toshihiko Horie, Keiichi Kaneko, Masaki Nakagawa
